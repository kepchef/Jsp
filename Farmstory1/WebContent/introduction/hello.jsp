    ...
    <section class="cate1">
        <aside>
            ...
            <ul class="lnb">
                ...
                <li><a href="/Farmstory1/introduction/direction.jsp">찾아오시는 길</a></li>
            </ul>
        ...
        <article>
            ...
            <div class="hello">
                        <img src="../img/sub_page1_article_bg.jpg" alt="건강한 먹거리를 위해 노력합니다.">
                        <img src="../img/sub_page1_article_txt.png" alt="안전한 농작물">
                        <img src="../img/sub_page1_article_family.png" alt="사진">
                        <h5> </h5>
                        <span>
                            <p>
                                ...
                                <br/>
                                <strong>친환경 농장<br/></strong>
                                팜스토리는 경기도 이천에 위치한 10만평 규모의 유기농 제배단지입니다.<br/>
                                <br/>
                                <strong>친환경 캠페인<br/></strong>
